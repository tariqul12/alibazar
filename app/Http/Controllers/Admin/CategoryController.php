...
class CategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $categories = $categories->orderBy('name', 'ASC')->paginate(Helpers::pagination_limit())->appends($query_param);
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('meta_image')) {
            $category->meta_image = ImageManager::update('category/', $category->meta_image, 'png', $request->file('meta_image'));
        }
