...
class PaymentMethodController extends Controller
{
    ...
    public function update(Request $request, $name)
    {
        ...
        if ($name == 'digital_payment') {
        ...
        }   elseif ($name == 'portwallet_pay') {
            $payment = BusinessSetting::where('type', 'portwallet_pay')->first();
            if (isset($payment) == false) {
                DB::table('business_settings')->insert([
                    'type' => 'portwallet_pay',
                    'value' => json_encode([
                ...
                DB::table('business_settings')->where(['type' => 'portwallet_pay'])->update([
                    'type' => 'portwallet_pay',
                    'value' => json_encode([
                        'status' => $request['status'],
                        'environment' => $request['environment'],
            ...
            DB::table('business_settings')->updateOrInsert(['type' => 'nagad'], [
                'value' => json_encode([
                    'status' => $request['status'],
                    'environment' => $request['environment'],
