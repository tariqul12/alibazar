...
class BusinessSettingsController extends Controller
{
    ...
    public function othersSettings()
    {
        ...
        return view('admin-views.business-settings.others-settings', compact('company_name','company_email','company_phone','digital_product','brand'));
    }
    public function updateDefaultSeo(Request $request)
    {
        // meta title
        DB::table('business_settings')->updateOrInsert(['type' => 'meta_title'], [
            'value' => $request['meta_title']
        ]);
        // meta Description
        DB::table('business_settings')->updateOrInsert(['type' => 'meta_description'], [
            'value' => $request['meta_description']
        ]);

        //meta logo
        $webLogo = BusinessSetting::where(['type' => 'meta_image'])->first();
        if ($request->has('meta_image')) {
            $webLogo = ImageManager::update('company/', $webLogo, 'png', $request->file('meta_image'));
            DB::table('business_settings')->updateOrInsert(['type' => 'meta_image'], 
                ['value' => $webLogo
            ]);
        }
    ...
    public function updateDefaultQuotation(Request $request)
    {
        // quotation_subject
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_subject'], [
            'value' => $request['quotation_subject']
        ]);
        // quotation_note
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_note'], [
            'value' => $request['quotation_note']
        ]);
        // quotation vat
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_vat'], [
            'value' => $request['quotation_vat']
        ]);
        // quotation_remarks
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_remarks'], [
            'value' => $request['quotation_remarks']
        ]);
        // quotation_remarks
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_remarks_1'], [
            'value' => $request['quotation_remarks_1']
        ]);
        // quotation_signature
        DB::table('business_settings')->updateOrInsert(['type' => 'quotation_signature'], [
            'value' => $request['quotation_signature']
        ]);
    ...
    public function updateInfo(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'vat_settings'], [
            'value' => $request['vat_settings']
        ]);
        ...
        if ($request->has('company_web_logo')) {
            $webLogo = ImageManager::update('company/', $webLogo, $request->file('company_web_logo')->extension(), $request->file('company_web_logo'));
