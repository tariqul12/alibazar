...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('meta_image')) {
            $brand->meta_image = ImageManager::upload('brand/', 'png', $request->file('meta_image'));
        }
    ...
    function list(Request $request)
    {
        ...
        $br = Brand::withCount('brandAllProducts')
            ...
            ->orderBy('name','asc')->paginate(Helpers::pagination_limit())->appends($query_param);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->meta_image) {
            $brand->meta_image = ImageManager::update('brand/', $brand->meta_image, 'png', $request->file('meta_image'));
        }
        $brand->meta_title       = $request->meta_title;
        $brand->meta_description = $request->meta_description;
