...
class BkashPaymentController extends Controller
{
    ...
    public function createPayment(Request $request)
    {
        ...
        $value = CartManager::cart_grand_total()-$discount-$user_point_amt;
    ...
    public function bkashSuccess(Request $request)
    {
        ...
        // create a session rather passing the value
        return response()->json(['status' => true, 'bkash_order_id' => $order_id]);
    }
}