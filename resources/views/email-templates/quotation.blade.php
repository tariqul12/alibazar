...
<head>
    ...
    <title>{{\App\CPU\translate('Quotation')}}</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2"
                        ...
                        <span style="font-size: 18px; font-weight: normal;">{{\App\CPU\translate('Notification mail for new quotation received')}}</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        ...
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            ...
                            {{\App\CPU\translate('We have sent you this email to notify that you have submit a quotation')}}.

                            <br/><br/>

                            {{\App\CPU\translate('Reference No')}} :

                            <a href="javascript:"> <h3 style="font-weight: 1000">{{$ref_no}}</h3> </a>
