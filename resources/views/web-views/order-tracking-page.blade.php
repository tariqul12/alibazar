        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-6">
                <div class="container py-4 mb-2 mb-md-3">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#track-order">
                      Launch demo modal
                    </button>
                    
                    <!-- Modal -->
                    <div class="modal fade" id="track-order" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="auth-content-wrapper">
                                    <div class="track-intro">
                                        <div class="track-intro-img">
                                            <img src="{{asset('public/assets/front-end/img/track.png')}}">
                                        </div>
                                            ...
                                            <div style="margin: 0 auto; padding: 15px;">
                                                ...
                                                <form action="{{route('track-order.result')}}" type="submit" method="post"
                                                    ...
                                                    <div class="form-group track-group">
                                                        <img src="{{asset('public/assets/front-end/img/mob.png')}}">
                                                        <input class="form-control prepended-form-control border-none" type="text" name="phone_number"
                                                               placeholder="{{\App\CPU\translate('your_phone_number')}}" required>
                                                    </div>
                                                    <div class="input-group-append track-btn">
