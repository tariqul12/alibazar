...
if($customerDetail['is_email_verified']==1) $phonereadonly='';
else $phonereadonly='readonly';
        ...
        <!-- Content  -->
            <section class="col-lg-12 col-md-12">
                ...
                <div class="card box-shadow-sm dash-right-side">
                     <h1 class="h3 float-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} headerTitle">{{\App\CPU\translate('account_information')}}</h1> 
                    <div class="card-header">
                        ...
                        <form class="mt-3" action="{{route('user-update')}}" method="post"
                            ...
                            <div class="row photoHeader">
                                ...
                                @csrf
                                   <img id="blah" style="width: 60px;height: 60px;"
                                             src="{{asset('storage/app/public/profile/'.auth('customer')->user()->image)}}"
                                             onerror="this.src='{{asset('public/assets/front-end/img/profile-image-place-holder.png')}}'"
                                             class="img-profile rounded-circle">

                                <div class="col-md-10 {{Session::get('direction') === "rtl" ? 'pr-2' : 'pl-2'}}" style="padding-top: 5px;">
                                ...
                                <div class="card-body mt-md-3" style="padding: 0px;">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control border-radius" id="f_name" name="f_name"
                                                   value="{{$customerDetail['f_name']}}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="lastName"> {{\App\CPU\translate('last_name')}} </label>
                                            <input type="text" class="form-control border-radius" id="l_name" name="l_name"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control border-radius" type="email" id="account-email" name="account_email"
                                                   value="{{$customerDetail['email']}}" {{ !empty($customerDetail['email']) ? 'readonly' : '' }}>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control border-radius" type="text" id="phone"
                                                   name="phone"
                                                   value="{{$customerDetail['phone']}}" {{$phonereadonly}} >
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="password-toggle">
                                                <input class="form-control border-radius" name="password" type="password"
                                                       id="password"
                                                >
                                                <label class="password-toggle-btn">
                                                    <input class="custom-control-input border-radius" type="checkbox"
                                                           style="display: none">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="password-toggle">
                                                <input class="form-control border-radius" name="con_password" type="password"
                                                       id="confirm_password">
                                                <div>
                                                    <label class="password-toggle-btn">
                                                        <input class="custom-control-input border-radius" type="checkbox"
                                    ...
                                    <button type="submit" class="profile-update-btn">{{\App\CPU\translate('update')}} </button>
