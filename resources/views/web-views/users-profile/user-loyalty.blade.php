        ...
        <div class="modal-body" style="padding:20px!important;">
            ...
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <input class="form-control border-radius" type="number" id="city" name="point" required >
                </div>
            </div>
          
        </div>
        <div class="modal-footer">
          <!--<button type="button" class="dashboard-track-order" data-dismiss="modal">{{\App\CPU\translate('close')}}</button>-->
          <button type="submit" class="d-genaret-invoice">{{\App\CPU\translate('submit')}}</button>
        </div>
    </form>
      </div>
    </div>
