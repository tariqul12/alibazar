    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row no-gutters">
            <div class="col-lg-6 iframe-full-height-wrap ">
                <img style="" class="for-contac-image" src="{{asset("public/assets/front-end/img/help.gif")}}" alt="">
            </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input class="form-control mobile_number"  type="text" name="mobile_number" onkeypress="return validateNumber(event)"
