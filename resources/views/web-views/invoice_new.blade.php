  ...
  <div style="background: #fff;height:100%;margin-left:-30px;margin-right:-30px;margin-top:-30px;font-family: 'Poppins', sans-serif;">
    <div style="height:90%;">
       <table style="width: 100%;font-family: 'Poppins', sans-serif;">
             <tbody>
              <tr>
                <td style="width: 50%;font-family: 'Poppins', sans-serif;">
              ...
              <tr style="">
                ...
                <td style="width: 38%;">
                    <div style="margin-top: 30px;margin-left:100px;">
                      ...
                      <p style="margin: 0px;font-size: 12px;">{{$order->shippingAddress ? $order->shippingAddress['contact_person_name'] : ""}}</p>
                      <p style="margin: 0px;font-size: 12px;">{{$order->shippingAddress ? $order->shippingAddress['address'] : ""}}</p>
                      <p style="margin: 0px;font-size: 12px;">{{$order->shippingAddress ? $order->shippingAddress['city'] : ""}} {{$order->shippingAddress ? $order->shippingAddress['zip'] : ""}}</p>
                      <p style="margin: 0px;font-size: 12px;">{{$order->customer['phone']}}</p>
          ...
          <table style="width: 100%;">
              ...
              <tbody>
                ...
                <tr style="border-bottom: 1px solid #ccc6c6;background: #fff;">
                  ...
                  <td style="font-size:11px;padding:5px;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['discount']))}}</td>
                   <td style="font-size:11px;padding:5px;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($subtotal-($details['discount']*$details->qty)))}}</td>
            ...
            @endforeach
                <tr style="border-bottom: 1px solid #ccc6c6;background: #f1f1f1;">
                  <td></td>
                  <td colspan="4" style="font-size:11px;padding:5px;">Subtotal</td>
                  <td style="font-size:11px;padding:5px;">Tk.{{$sub_total-$total_discount_on_product}}</td>
                </tr>
                
                @if($total_tax > 0)
                <tr style="border-bottom: 1px solid #ccc6c6;background: #fff;">
                  <td></td>
                  <td colspan="4" style="font-size:11px;padding:5px">Tax Fee</td>
                ...
                <tr style="border-bottom: 1px solid #ccc6c6;background: #f1f1f1;">
                  <td></td>
                  <td colspan="4" style="font-size:11px;padding:5px;">Delivery Fee</td>
                ...
                <tr style="border-bottom: 1px solid #ccc6c6;">
                    <td></td>
                    <td colspan="4" style="font-size:11px;padding:5px;background: #fff;">Coupon Discount</td>
                ...
                <tr style="border-bottom: 1px solid #ccc6c6;">
                  <td></td>
                  <td colspan="4" style="font-size:11px;padding:5px;background: #fff;">Loyalty Discount</td>
                ...
                <tr style="border-bottom: 1px solid #ccc6c6;background: #f1f1f1;">
                  <td></td>
                  <td colspan="4" style="font-size:11px;padding:5px;">Total</td>
