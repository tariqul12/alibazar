                    ...
                    <td style="vertical-align: top">
                        <div class="quotation-creator">
                            ...
                            <h6 style="font-size: 12px;font-weight:bold;margin-bottom: 8px;font-family: 'Poppins', sans-serif!important;">Attn:
                                {!! $quotation->customer->f_name !!} {!! $quotation->customer->l_name !!}</h6>
                            
                            <p style="margin: 0px;font-size: 11px;font-family: 'Poppins', sans-serif!important;">Contact: {!! $quotation->customer->phone !!}</p>
                            <p style="margin: 0px;font-size: 11px;font-family: 'Poppins', sans-serif!important;">Email: {!! $quotation->customer->email !!}</p>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table
                ...
                <thead>
                    <tr style="background: #f2f2f2;">
                        ...
                        <!--<th style="text-align: center;vertical-align: bottom;padding: 5px;border: 1px solid black;font-size:10px;display:none;">UnitPrice (W/O Vat)</th>
                        <th style="text-align: center;vertical-align: bottom;padding: 5px;border: 1px solid black;font-size:10px;display:none;">VAT</th>
                        <th style="text-align: center;vertical-align: bottom;padding: 5px;border: 1px solid black;font-size:10px;display:none;">UnitVat Amount</th>-->
                        <th style="text-align: center;vertical-align: bottom;padding: 5px;border: 1px solid black;font-size:10px;display:none;">Unit Price</th>
                ...
                <tbody>
                    ...
                    @endphp
                        @foreach ($quotation->productQuotations as $key => $pro)
                            <tr class="">
                                ...
                                <td style="padding: 2px;border: 1px solid black;font-size:10px; text-align:left;padding-left:10px;">{!! $pro->product->details !!}</td>
                                
                                <!--<td style="padding: 2px;border: 1px solid black;font-size:6px!important; text-align:left;padding-left:10px;">{!! $pro->product->features !!} </td>-->
                                ...
                                <!--<td style="padding: 2px;border: 1px solid black;font-size:11px;display:none;">Tk.{!! $pro->unit_price !!}</td>
                                <td style="padding: 2px;border: 1px solid black;font-size:11px;display:none;"> Tk.{!! $pro->tax !!}</td>
                                <td style="padding: 2px;border: 1px solid black;font-size:11px;display:none;">Tk.{!! $pro->single_unit_vat !!} </td>-->
                                <td style="padding: 2px;border: 1px solid black;font-size:11px;display:none;text-align:center;"> Tk.{!! $pro->net_unit_price-$pro->discount !!} </td>
                                <td style="padding: 2px;border: 1px solid black;border-right:0px;font-size:11px;text-align:center;">Tk.{!! $pro->total-($pro->discount*$pro->qty) !!} </td>
                            </tr>
                            @php
                                $grand_total +=($pro->total-($pro->discount*$pro->qty));
                            @endphp
                        @endforeach
                    @endif
                    @php
                        ...
                        {
                            $total_vat=$quotation_data->total_vat;
                        }
                     @endphp
                    @if($total_vat>0)
                        <tr>
                    ...
                    @endif
                    <tr>
                        <td colspan="6" style="padding: 4px;border: 0.5px solid black;font-size:10px;text-align:right"><strong>Total :</strong> </td>
                        <td colspan="2" style="padding: 4px;text-align: right; border: 1px solid black;font-size:11px;"><strong>Tk.{{$grand_total+$total_vat}}</strong></td>
                    </tr>
                    <!--<tr>
