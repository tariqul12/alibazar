                                  ...
                                  <div class="form-content text-center">
                                    ...
                                    <div class="input-group">
                                      <input class="form-control" type="email" value="{{old('email')}}"  name="email"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" required placeholder="{{\App\CPU\translate('email_address')}}">
                                    ...
                                    <div class="d-grid">
                                      ...
                                      <button class="btn btn-email" type="button" style="color: #EB7F11 !important">
                                       ...
                                       <a href="{{route('customer.auth.login')}}"> Already have an account?</a>
                                      </button>
                                    </div>
