<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/business-settings/logistic-module') ?'active':'' }}"><a href="{{route('admin.business-settings.logistic-module.index')}}">{{\App\CPU\translate('REDX_Config')}}</a></li>
