    ...
    <div class="content container-fluid">
        ...
        <div class="row gy-3">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">SMSQ_SMS</h5>
                    </div>
                    <div class="card-body text-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                        <span class="badge text-wrap badge-soft-info mb-3">NB : #OTP# will be replace with otp</span>
                        @php($config=\App\CPU\Helpers::get_business_settings('smsq_sms'))
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.sms-module-update',['smsq_sms']):'javascript:'}}"
                              style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                              method="post">
                            @csrf
                            <label class="mb-3 d-block title-color">SMSQ_SMS</label>
                            ...
                            <div class="form-group">
                                <label class="text-capitalize title-color">ClientId</label>
                                <input type="text" class="form-control" name="client_id"
                                       value="{{env('APP_MODE')!='demo'?$config['client_id']??"":''}}">
                            </div>
                            <div class="form-group">
                                <label class="text-capitalize title-color">SenderId</label>
                                <input type="text" class="form-control" name="senderId"
                                       value="{{env('APP_MODE')!='demo'?$config['senderId']??"":''}}">
                            </div>
                            ...
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\translate('order_status_template')}}</label>
                                <input type="text" class="form-control" name="order_status_template"
                                       value="{{env('APP_MODE')!='demo'?$config['order_status_template']??"":''}}">
                            </div>
                            <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
