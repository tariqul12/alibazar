                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label text-capitalize">{{\App\CPU\translate('VAT Value ')}}({{\App\CPU\translate(' ex: 0.00')}})</label>
                                <input type="number" value="{{$vat_value->value}}"
                                       name="vat_settings" class="form-control" min="0" placeholder="{{\App\CPU\translate('4')}}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="mt-4 position-relative">
                                <input type="file" name="company_web_logo" id="customFileUploadWL"
                                        ...
                                        accept=".jpg, .png, .jpeg, .gif, .svg, .bmp, .tif, .tiff|image/*">>
