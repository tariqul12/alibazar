            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method.update',['portwallet_pay']):'javascript:'}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                                @php($config['environment'] = $config['environment']??'sandbox')
                                <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                                    <h5 class="text-uppercase">{{\App\CPU\translate('portwallet_pay')}}</h5>
                                    ...
                                    <label class="switcher show-status-text">
                                        ...
                                        <span class="switcher_control"></span>
                                                              ...
                                                              <center class="mb-3">
                                    <img height="60" src="{{asset('/public/assets/back-end/img/portpos-black.svg')}}"
                                         alt="portwallet_pay">
                                </center>
                                ...
                                <div class="form-group">
                                    ...
                                    <div
                                        class="form-control d-flex align-items-center justify-content-between py-1 pl-3 pr-2">
                                        <span class="form-ellipsis {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"
                                              id="id_portwallet_pay">{{ url('/') }}/return-portwallet-pay</span>
                                        <span class="btn btn--primary text-nowrap btn-xs"
                                              onclick="copyToClipboard('#id_portwallet_pay')">
                                        <i class="tio-copy"></i>
                                        {{\App\CPU\translate('Copy URI')}}
                                    </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="d-flex title-color">{{\App\CPU\translate('api_key')}}</label>
                                    <input type="text" class="form-control" name="api_key"
                                           value="{{env('APP_MODE')!='demo'?$config['api_key']:''}}">
                                </div>
                                <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method.update',['nagad']):'javascript:'}}"
                            method="post">
                        @csrf
                        @if(isset($config))
                                @php($config['environment'] = $config['environment']??'sandbox')
                                <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                                    <h5 class="text-uppercase">{{\App\CPU\translate('Nagad')}}</h5>
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('/public/assets/back-end/img/nagad.png')}}" alt="">
                                </center>
                                ...
                                <div class="form-group">
                                    <label class="d-flex title-color">{{\App\CPU\translate('nagad_PG_public_key')}}</label>
                                    <input type="text" class="form-control" name="public_key"
                                           value="{{env('APP_MODE')!='demo'?$config['public_key']:''}}">
                                </div>

                                <div class="form-group">
                                    <label class="d-flex title-color">{{\App\CPU\translate('nagad_merchant_private_key')}}</label>
                                    <input type="text" class="form-control" name="private_key"
                                           value="{{env('APP_MODE')!='demo'?$config['private_key']:''}}">
                                </div>

                                <div class="form-group">
                                    <label class="d-flex title-color">{{\App\CPU\translate('NAGAD_MERCHANT_ID')}}</label>
                                    <input type="text" class="form-control" name="merchant_id"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_id']:''}}">
                                </div>

                                <div class="form-group">
                                    <label class="d-flex title-color">{{\App\CPU\translate('NAGAD_MERCHANT_NUMBER')}}</label>
                                    <input type="text" class="form-control" name="merchant_number"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_number']:''}}">
                                </div>
