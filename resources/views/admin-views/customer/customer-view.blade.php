    ...
    <div class="content container-fluid">
        ...
        <div class="row" id="printableArea">
            ...
            <div class="col-lg-4">
                ...
                <!--start address cart-->
                @if($customer && sizeof($shippingAddresses) > 0)
                    @foreach($shippingAddresses as $shippingAddress)
                    <div class="card address-box" style="text-transform: capitalize;margin-top: 3px;">                   
                        <div class="card-header" style="padding: 5px;justify-content: unset;">
                            <div class="dash-address-pin">
                                <i class="tio-pin iconHad" aria-hidden="true"></i>
                            </div>
