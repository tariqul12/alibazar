    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ \App\CPU\translate('Blog Add') }}</li>
            </ol>
        </nav>
    {{-- add --}}
    <form class="user" action="{{ route('admin.blog.blog_store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="title" placeholder="{{ \App\CPU\translate('Ex: title') }}" required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="post" class="textarea editor-textarea" placeholder="Post here..." required></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="meta_key" placeholder="{{ \App\CPU\translate('Ex: meta key') }}">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="" cols="110" rows="5" class="form-control form-control-user" placeholder="Describe here..."></textarea>
                        </div>
                    </div>
                </div>
