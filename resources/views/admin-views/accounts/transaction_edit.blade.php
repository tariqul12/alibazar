...
@section('title', \App\CPU\translate('Transaction Edit'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ \App\CPU\translate('Transaction Edit') }}</li>
            </ol>
        </nav>
    </div>
    {{-- add --}}
    <form class="user" action="{{ route('admin.account.transaction_update') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cust_id" id="" class="form-control form-control-user" required>
                                ...
                                @foreach ($customer as $row)
                                    <option value="{{ $row->id }}"
                                        @if($row->id==$txn_data->customer_id)
                                        {
                                            {{'selected'}}
                                        }
                                        @endif
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="co" placeholder="{{ \App\CPU\translate('Ex: C/O') }}" value="{{$txn_data->co}}" required>
                                <input type="hidden" name="txn_id" value="{{$txn_data->id}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="exampleFirstName"
                                ...
                                <select name="account_no" id="" class="form-control form-control-user" required readonly>
                                    <option value="">--Select--</option>
                                    @foreach ($accounts as $row)
                                        <option value="{{ $row->id }}"
                                            @if($row->id==$txn_data->account_id)
                                            {
                                                {{'selected'}}
                                            }
                                            @endif
                                            >{{ $row->account_no }}-{{ $row->name}}</option>
                                    @endforeach
                                </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-user" id="exampleFirstName"
                                name="txn_dt" value="{{$txn_data->date}}" required>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="amount" placeholder="{{ \App\CPU\translate('Ex: 5000') }}" value="{{$txn_data->amount}}" required readonly>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="" class="form-control form-control-user" required readonly>
                                <option value="">--Select--</option>
                                <option value="Income"
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="note" placeholder="{{ \App\CPU\translate('Ex: Text') }}"value="{{$txn_data->note}}" required>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-center justify-content-end gap-10">
                    <button type="submit" class="btn btn--primary btn-user"
                        id="apply">{{ \App\CPU\translate('Update Transaction') }}</button>
                </div>
            </div>
        </div>
    </form>
