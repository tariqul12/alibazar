        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-12">
                <div class="card card-body">
                    ...
                    <p>4. {{\App\CPU\translate('You can get brand and category id from their list, please input the right ids.')}}</p>

                    <p>5. In excel file items upload not more than 100</p>

                </div>
            </div>

            <div class="col-md-12 mt-2">
                <form class="product-form" action="{{route('admin.product.bulk-update')}}" method="POST"
                    ...
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            ...
                            <a href="{{asset('public/assets/product_bulk_update_format.xlsx')}}" download=""
