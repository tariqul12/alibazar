    ...
    <div class="row mt-20">
        <div class="col-md-12">
            <div class="card">
				...
				<th class="text-right">{{\App\CPU\translate('unit_price_/_discount')}}</th>
                        ...
                        @foreach($pro as $k=>$p)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.product.view',[$p['id']])}}" class="media align-items-center gap-2" title="{{$p['name']}}">
                                        ...
                                        <span class="media-body title-color hover-c1" title="{{$p['name']}}">
				...
				<td class="text-right">
                                    @php
                                        ...
                                        {
                                            $discount_amount=$p['unit_price']*($p['discount']/100);
                                        }
                                        else{
                                            $discount_amount=$p['discount'];
                                        }
                                    @endphp
                                   {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($p['unit_price']-$discount_amount))}} /{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($discount_amount))}}
                                </td>
