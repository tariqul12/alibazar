...
@section('content')
@php
    $courier=DB::table("courier_service")->where('status',1)->get();
@endphp
                    ...
                    <div class="card">
                        ...
                        <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form">
                            <div class="col-md-12 form-group pt-1">
                                ...
                                <textarea name="specifications" class="textarea editor-textarea"></textarea>
                            </div>
                        </div>
                        <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form">
                            <div class="col-md-12 form-group pt-1">
                                <label class="title-color pt-4">{{ \App\CPU\translate('quick_links') }}</label>
                                <!--<textarea rows="5" type="text" name="quick_links" class="form-control pt-4"></textarea>-->
                                <textarea name="quick_links" class="textarea editor-textarea"></textarea>
                            </div>
                        </div>
                        <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form">
                            <div class="col-md-12 form-group pt-1">
                                <label class="title-color pt-4">{{ \App\CPU\translate('Features') }}</label>
                                <textarea name="features" class="textarea editor-textarea"></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($courier as $item)
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6 mt-2">
                                      <input type="text" name="courier_amount[{{$item->id}}]" class="form-control" placeholder="Courier Service Amount" required >
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        value="0" name="loyalty_point" class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
