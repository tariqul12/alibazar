...
<div class="row">
	<div class="col-md-8 mx-auto">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.maxupdate') }}" method="POST" enctype="multipart/form-data">
					@csrf
					...
					<div class="border-top pt-3">
						...
						<div class="header-nav-menu">
							<input type="hidden" name="types[]" value="header_menu_labels_update">
							<input type="hidden" name="types[]" value="header_menu_links_update">
							@if (get_setting('header_menu_labels_update') != null)
								@foreach (json_decode( get_setting('header_menu_labels_update'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-4">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{translate('Label')}}" name="header_menu_labels_update[]" value="{{ $value }}">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{ translate('Link with') }} http:// {{ translate('or') }} https://" name="header_menu_links_update[]" value="{{ json_decode(App\Models\BusinessSetting::where('type', 'header_menu_links_update')->first()->value, true)[$key] }}">
											</div>
										</div>
										<div class="col-auto">
