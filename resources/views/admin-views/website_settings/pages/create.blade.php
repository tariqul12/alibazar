...
@section('title', \App\CPU\translate('Page Add'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="page-form" action="{{ route('admin.custom-pages.store') }}" method="POST" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-12 form-group pt-1">
                                ...
                                <textarea name="content" class="textarea editor-textarea"></textarea>
                            </div>
                       </div>                  
