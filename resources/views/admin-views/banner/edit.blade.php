                                ...
                                <div class="col-md-6 mb-5 mb-lg-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100"
                                            ...
                                            <option value="Home Slider First Ad" {{$banner['banner_type']=='Home Slider First Ad'?'selected':''}}>Home Slider First Ad</option>
                                            <option value="Home Slider Second Ad" {{$banner['banner_type']=='Home Slider Second Ad'?'selected':''}}>Home Slider Second Ad</option>
                                            <option value="Home Ad 01" {{$banner['banner_type']=='Home Ad 01'?'selected':''}}>Home Ad 01</option>
                                            <option value="Home Ad 02" {{$banner['banner_type']=='Home Ad 02'?'selected':''}}>Home Ad 02</option>
                                            <option value="New Arrivals" {{$banner['banner_type']=='New Arrivals'?'selected':''}}>New Arrivals</option>
                                            <option value="Top Rated" {{$banner['banner_type']=='Top Rated'?'selected':''}}>Top Rated</option>
                                        </select>
                                    </div>
