                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100"
                                            ...
                                            <option value="Home Slider First Ad">Home Slider First Ad</option>
                                            <option value="Home Slider Second Ad">Home Slider Second Ad</option>
                                            <option value="Home Ad 01">Home Ad 01</option>
                                            <option value="Home Ad 02">Home Ad 02</option>
