                    ...
                    <div class="card-body">
                        <form action="{{ url()->current() }}" id="form-data" method="GET">
                            <div class="row gy-3 gx-2">
                                ...
                                <div class="col-sm-6 col-md-2">
                                    <div class="form-floating">
                                        <select name="payment_type" class="form-control" style="padding-top: 10px;">
                                            <option value="all" {{ $payment_type == 'all' ? 'selected' : '' }}>All</option>
                                            <option value="paid" {{ $payment_type == 'paid' ? 'selected' : '' }}>Paid</option>
                                            <option value="unpaid" {{ $payment_type == 'unpaid' ? 'selected' : '' }}>Unpaid</option>
                                        </select>
                                        <label>Payment Type</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-2 mt-2 mt-sm-0  ">
                        ...
                        <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th>{{\App\CPU\translate('Order Type')}}</th>
                                ...
                                <tr class="status-{{$order['order_status']}} class-all">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a class="btn btn-outline-success square-btn btn-sm mr-1" target="_blank" title="{{\App\CPU\translate('Chalan')}}"
                                            ...
                                            <a class="btn btn-outline-info square-btn btn-sm mr-1" target="_blank" title="{{\App\CPU\translate('Mushok')}}"
                                                href="{{route('admin.orders.generate-mushok',[$order['id']])}}">
                                                <i class="tio-download-to"></i>
                                            </a>
                                            @if($order['order_status']=='pending')
                                            <a class="btn btn-outline-info square-btn btn-sm mr-1" target="_blank" title="{{\App\CPU\translate('Order_edit')}}"
                                                href="{{route('admin.orders.edit_order',[$order['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            @endif
                                            @if($order['order_status']=='confirmed' && $order['delivery_status']=='0')
                                            <a class="btn btn-outline-dark square-btn btn-sm mr-1" target="_blank" title="Create New Parcel"
                                               href="{{route('admin.parcel.create',['order_id'=>$order['id']])}}">
