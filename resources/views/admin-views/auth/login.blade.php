...
<body style="background-color: #0E2F56;">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <!-- Card -->
                <div class="card card-lg mb-5" style="border-radius: 0px;">
                    <div class="card-body">
                        <!-- Form -->
                        <form id="form-id" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="email" class="form-control form-control-lg br-0" name="email" id="signinSrEmail"
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg br-0"
                           ...
                           @if(isset($recaptcha) && $recaptcha['status'] == 1)
                            ...
                            <button type="submit" class="btn btn-lg btn-block btn--primary br-0">{{\App\CPU\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
