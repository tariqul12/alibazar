...
<!--        <tr>
        ...
        <tr>
            ...
            <td class="text-right"> {{\App\CPU\translate('VAT')}}:</td>
            <td class="text-right">{{\App\CPU\Helpers::currency_converter(round($vatAmt,2))}}</td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td class="text-right">{{\App\CPU\translate('Subtotal')}}:</td>
            <td class="text-right">{{\App\CPU\Helpers::currency_converter(round($sub_total+$vatAmt,2))}}</td>
        </tr>
        <tr>
            <td colspan="2"></td>
       ...
       @if(isset($feeInfo['fee_amount']) && $feeInfo['fee_amount'] != '0')
        ...
        <tr>
            <td colspan="2"></td>
            <td class="text-right">{!! isset($feeInfo['fee_title']) ? $feeInfo['fee_title'] : ''  !!}:</td>
            <td class="text-right">{!! isset($feeInfo['fee_amount']) ? \App\CPU\Helpers::currency_converter(round($feeInfo['fee_amount'],2)) : ''  !!}</td>
        </tr>
        @endif
        <tr>
            <td colspan="2"></td>
