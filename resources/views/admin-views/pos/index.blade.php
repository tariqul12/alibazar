                    ...
                    <div class="card">
                        ...
                        <div class="px-3 py-4">
                            <div class="row gy-1">
                                ...
                                <div class="col-sm-2">
                                    <button class="btn btn-success rounded text-nowrap" id="add_new_product" type="button" data-toggle="modal" data-target="#add-product" title="Add Product">
                                        <i class="tio-add"></i>
                                         Product
                                    </button>
                                </div>
                    ...
                    <div class="card billing-section-wrap">
                        ...
                        <div class="card-body">
                            <div class="form-group d-flex gap-2">
                                <select onchange="customer_change(this.value);" id='customer' name="customer_id" data-placeholder="Guest" class="js-data-example-ajax form-control form-ellipsis">
