                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="subject" required class="form-control subject_input" placeholder="Write your subject line" value="{!!   request()->get('subject_line') !!}">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="search-box input-group">
                                            <button class="btn btn-secondary"><i class="tio-barcode"></i></button>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shipping_vat" class="form-control shipping_vat" value="0"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
