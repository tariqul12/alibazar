            ...
            <table
                ...
                <thead>
                    <tr style="background: #f2f2f2;">
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">No</th>
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Item Name</th>
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Spec</th>
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Unit</th>
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">QTY</th>
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Unit Price</th>
                        @if($quotation_data->is_vat==1)
                            <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">VAT</th>
                            <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Unit Vat Amount</th>
                            <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;font-size:10px;">Unit Price(With Vat)</th>
                        @endif
                        <th style="text-align: center;vertical-align: middle;padding: 5px;border: 1px solid black;border-right:0px;font-size:10px;width:12%;">Total Price</th>
                    </tr>
                </thead>
                <tbody>
                      @php
                    ...
                    @if (count($quotation->productQuotations))
                        ...
                        @foreach ($quotation->productQuotations as $key => $pro)
                            ...
                            <tr class="">
                                ...
                                <td style="padding: 2px;border: 1px solid black;font-size:10px;text-align:center;"> {!! isset($pro->name)?$pro->name:$pro->product->name !!}</td>
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px;border: 0.5px solid black;font-size:10px;text-align:center;">TK.{{$quotation->shipping_cost}}</td>
                        <td style="padding: 4px;border: 0.5px solid black;font-size:10px;text-align:center;">{{$quotation->shipping_vat}}%</td>
                        <td style="padding: 4px;border: 0.5px solid black;font-size:10px;text-align:center;">TK.{{ round(($quotation->shipping_cost*($quotation->shipping_vat/100)),2)}}</td>
                        <td colspan="2" style="padding: 4px;text-align:center; border: 1px solid black;font-size:11px;">{{App\CPU\Helpers::currency_converter($quotation->shipping_amount)}}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding: 4px;text-align:center; border: 1px solid black;font-size:11px;">{{App\CPU\Helpers::currency_converter($grand_total + $total_vat+$quotation->shipping_amount)}}</td>
                    </tr>
                    <!--<tr>
