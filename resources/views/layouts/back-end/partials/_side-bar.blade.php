            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <!--    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/pos*')?'active':''}}">-->
                        <!--        <a class="js-navbar-vertical-aside-menu-link nav-link"-->
                        <!--           title="{{\App\CPU\translate('New Sale')}}" href="{{route('admin.pos.add-invoice')}}">-->
                        <!--            <i class="tio-shopping nav-icon"></i>-->
                        <!--            <span-->
                        <!--                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('New Sale')}}</span>-->
                        <!--        </a>-->
                        <!--    </li>-->
                        <!--@endif-->
                        <!-- End POS -->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('order_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    {{-- sms templates --}}
                                    <li class="nav-item {{Request::is('admin/orders/sms-templates')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.orders.sms_templates')}}"
                                           title="{{\App\CPU\translate('SMS Templates')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{\App\CPU\translate('SMS Templates')}}
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <!-- Parcel Management -->
                        <li class="nav-item {{ (Request::is('admin/parcel*'))?'scroll-here ':''}}">
                            <small class="nav-subtitle"
                                   title="">Parcel Management</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/parcels*'))?'active show':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:">
                                <i class="tio-filter-list nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <span class="text-truncate">Parcel Management</span>
                                </span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/accounts/account_list') || Request::is('admin/accounts/account_add') ||  Request::is('admin/accounts/transaction_list')
                                || Request::is('admin/accounts/transection_add') || Request::is('admin/accounts/transfer_list') || Request::is('admin/accounts/transfer_add') || Request::is('admin/accounts/transfer_edit') || Request::is('admin/accounts/account_edit'))?'block':''}}">
                                <li class="nav-item {{Request::is('admin/parcels/parcel_list') ?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.parcel.parcel_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Parcel List</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/parcels/parcel_add') ?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.parcel.create')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Add New Parcel</span>
                                    </a>
                                </li>
                                <li class="nav-item  Request::is('admin/parcels/parcel_tracking')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.parcel.parcel_tracking')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Parcel Tracking</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <!--Parcel Management Ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || Request::is('admin/product/bulk-update') || (Request::is('admin/product/add-new')) || (Request::is('admin/product/view/*')) || (Request::is('admin/product/barcode/*')))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/product/list/in_house') || (Request::is('admin/product/stock-limit-list/in_house')) || (Request::is('admin/product/bulk-import'))  || (Request::is('admin/product/bulk-update'))|| (Request::is('admin/product/questions'))|| (Request::is('admin/product/add-new')) || (Request::is('admin/product/view/*')) || (Request::is('admin/product/barcode/*')))?'block':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/product/bulk-update')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.bulk-update')}}"
                                           title="Bulk Update">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Bulk Update</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/product/questions')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.questions')}}"
                                           title="Question & Answers">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Question & Answers</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/pick_up_points*')||Request::is('admin/pick_up_points')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:"
                                   title="{{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Pickup Points')}}">
                                    <i class="tio-airdrop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Pickup')}} {{\App\CPU\translate('Points')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/pick_up_points*')||Request::is('admin/pick_up_points*')?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/pick_up_points/create')?'active':''}}">
                                        <a class="nav-link"
                                           title="{{\App\CPU\translate('New')}} {{\App\CPU\translate('Pickup Points')}}"
                                           href="{{route('admin.pick_up_points.create')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('Add ')}} {{\App\CPU\translate('New')}} </span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/pick_up_points')?'active':''}}">
                                        <a class="nav-link"
                                           title="{{\App\CPU\translate('Denied')}} {{\App\CPU\translate('Pickup Points')}}"
                                           href="{{route('admin.pick_up_points.index')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('List')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            <li class="nav-item {{ (Request::is('admin/quotation*'))?'scroll-here':''}}">
                                <small class="nav-subtitle"
                                       title="">{{\App\CPU\translate('quotation_management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <!-- Pages -->

                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/quotations*'))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{\App\CPU\translate('quotation_management')}}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/quotations/list') || Request::is('admin/quotations/requests'))?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/quotations/list') ? 'active' : ''}}">
                                        <a class="nav-link " href="{{route('admin.quotation.list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Quotations')}}</span>
                                        </a>
                                    </li>

                                    <li class="nav-item {{Request::is('admin/quotations/requests') ? 'active':''}}">
                                        <a class="nav-link " href="{{route('admin.quotation.request')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">Quotation Request</span>
                                        </a>
                                    </li>
                        ...
                        <!--Quotation management ends-->
                        {{-- blog management --}}
                        <li class="nav-item {{ (Request::is('admin/quotation*'))?'scroll-here':''}}">
                            <small class="nav-subtitle"
                                   title="">{{\App\CPU\translate('blog_management')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/blog/blog_category'))?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:">
                                <i class="tio-filter-list nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <span class="text-truncate">{{\App\CPU\translate('blog_management')}}</span>
                                </span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/blog/blog_category') || Request::is('admin/blog/blog_list') || Request::is('admin/blog/blog_add'))?'block':''}}">
                                <li class="nav-item {{Request::is('admin/blog/blog_category')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.blog.category_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Category')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/blog/blog_list') || Request::is('admin/blog/blog_add')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.blog.blog_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('blog_list')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        {{-- blog management end --}}
                        {{-- account management --}}
                        <li class="nav-item {{ (Request::is('admin/account*'))?'scroll-here':''}}">
                            <small class="nav-subtitle"
                                title="">{{\App\CPU\translate('account_management')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/accounts*'))?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            href="javascript:">
                                <i class="tio-filter-list nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <span class="text-truncate">{{\App\CPU\translate('account_management')}}</span>
                                </span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/accounts/account_list') || Request::is('admin/accounts/account_add') ||  Request::is('admin/accounts/transaction_list')
                                || Request::is('admin/accounts/transection_add') || Request::is('admin/accounts/transfer_list') || Request::is('admin/accounts/transfer_add') || Request::is('admin/accounts/transfer_edit') || Request::is('admin/accounts/account_edit'))?'block':''}}">
                                <li class="nav-item {{Request::is('admin/accounts/account_list') || Request::is('admin/accounts/account_add') || Request::is('admin/accounts/account_edit')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.account.account_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('account')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/accounts/transection_list') || Request::is('admin/accounts/transection_add') || Request::is('admin/accounts/transection_edit')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.account.transaction_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('transaction')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/accounts/transfer_list') || Request::is('admin/accounts/transfer_add') || Request::is('admin/accounts/transfer_edit')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.account.transfer_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('transfer')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/customer/wallet*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/customer/wallet*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report') || Request::is('admin/customer/request_call_back'))?'block':'none'}}">
                                ...
                                {{-- request a call back --}}
                                <li class="nav-item {{Request::is('admin/customer/request_call_back')?'active':''}}">
                                    <a class="nav-link" title="{{\App\CPU\translate('request_call_back')}}"
                                       href="{{route('admin.customer.request_call_back')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                        {{\App\CPU\translate('request_call_back')}}
                                    </span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/website/footer*') || Request::is('admin/website/custom-pages*') || Request::is('admin/website/footer*') || Request::is('admin/website/pages*') || Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/social-media') || Request::is('admin/file-manager*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/website/footer*') || Request::is('admin/website/custom-pages*') || Request::is('admin/website/footer*') || Request::is('admin/website/pages*') || Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/social-media') || Request::is('admin/file-manager*')?'block':'none'}}">
                                ...
                                <li class="nav-item {{(Request::is('admin/website/custom-pages*') || Request::is('admin/website/pages*'))?'active':''}}">
                                    <a class="nav-link" href="{{route('admin.website.pages')}}"
                                       title="{{\App\CPU\translate('pages')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                      {{\App\CPU\translate('Custom Pages')}}
                                    </span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item {{Request::is('admin/website/footer*')?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{route('admin.website.footer')}}"
                                       title="{{\App\CPU\translate('Social_Media_Links')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CPU\translate('Footer')}}
                                </span>
                                    </a>
                                </li>
